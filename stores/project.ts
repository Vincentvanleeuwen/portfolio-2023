  ...
  state: () => ({
    projects: [
      ...
      },
      {
        ...
        description:
          "Momkai.com is the dynamic online portfolio of the digital design agency where I worked. It showcases a range of stunning design projects and provides a glimpse into the creative minds of the team behind them. From web design to branding, the site exemplifies the impressive talent and expertise of the Momkai team. This website was first built with React, and later I had to migrate the site to Webflow.",
